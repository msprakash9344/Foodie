...
import banner from "./images/roll banner.jpg"

import chickenroll from "./images/chicken roll.jpeg";
import muttonroll from "./images/mutton roll.jpeg";
import kadhiroll from "./images/kadhi roll.jpeg";
import amzingmeatyroll from "./images/amzing meaty roll.jpeg";
import paneertikkaroll from "./images/paneer tikka roll.jpeg";
import beefroll from "./images/beef roll.jpeg";
import vegspringroll from "./images/veg spring roll.jpeg";
import hotspicychickenroll from "./images/hot spicy chicken roll.jpeg";
import bhunachickenroll from "./images/bhuna chicken roll.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Chicken Roll", image: chickenroll, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Mutton Roll", image: muttonroll, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.4"},
    { id: 3, name: "Kadhi Roll", image: kadhiroll, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.5" },
    { id: 4, name: "Amzing Meaty Roll", image: amzingmeatyroll,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.2" },
    { id: 5, name: "Paneer Tikka Roll", image: paneertikkaroll, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.3"},
    { id: 6, name: "Beef Roll", image: beefroll, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.5" },
    { id: 7, name: "Veg Spring Roll", image: vegspringroll, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.5" },
    { id: 8, name: "Spicy Chicken Roll", image: hotspicychickenroll, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.4" },
    { id: 9, name: "Chicken Bhuna Roll", image: bhunachickenroll, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Rolls</span> Varieties for You</h2>
