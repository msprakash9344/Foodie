...
import banner from "./images/fried rice banner.jpg"

import chickenfriedrice from "./images/chicken friedrice.jpg";
import eggfriedrice from "./images/egg friedrice.jpg";
import prawnfriedrice from "./images/prawn friedrice.jpg";
import vegfriedrice from "./images/veg friedrice.jpg";
import beeffriedrice from "./images/beef friedrice.jpg";
import mushroomfriedrice from "./images/mushroom friedrice.jpg";
import machurianfriedrice from "./images/manchurian friedrice.jpg";
import cauliflowerfriedrice from "./images/cauliflower friedrice.jpg";
import schezwanfriedrice from "./images/schezwan fried rice.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Chicken Fried rice", image: chickenfriedrice, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Egg Fried rice", image: eggfriedrice, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.3"},
    { id: 3, name: "Prawn Fried rice", image: prawnfriedrice, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.4" },
    { id: 4, name: "Veg Fried rice", image: vegfriedrice,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.2" },
    { id: 5, name: "Beef Fried rice", image: beeffriedrice, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.5"},
    { id: 6, name: "Mushroom Fried rice", image: mushroomfriedrice, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.4" },
    { id: 7, name: "Gobi Fried rice", image: machurianfriedrice, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.2" },
    { id: 8, name: "cauliflower rice", image: cauliflowerfriedrice, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.3" },
    { id: 9, name: "Schezwan Fried Rice", image: schezwanfriedrice, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
   ...
   const [selectedFood, setSelectedFood] = useState(null);
    ...
    const handleOrderNow = (food) => {
      ...
      setOrderDetails({
        ...
        quantity: 1,
        paymentMethod: "Cash on Delivery",
        totalPrice: food.offerprice || food.price, // Base price for one item
      });
    };
    ...
    return (
      ...
      <div className="container py-5">
        <h2 className="text-center mb-4"> Our Delicious <span style={{color:"orangered"}}>Fried Rice</span> Varieties for You</h2>
            ...
            <div key={food.id} className="col-12 col-md-6 col-lg-4 card-container">
              <div className="card h-100 w-100 border-0 shadow image-container">
                ...
                <div className="card-body">
                  ...
                  <button className="cart-button" onClick={() => addToCart(food)}>Add to cart</button>
                </div>
              </div>
            </div>
          ))}
              ...
              <form>
                ...
                <div className="mb-3">
                  ...
                  >
                    ...
                    <option value="Cash on Delivery">GPay</option>
                    <option value="Credit/Debit Card">PhonePe</option>
