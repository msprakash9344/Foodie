...
import banner from "./images/chicken banner.jpg"

import grill from "./images/grill chicken.jfif";
import thandoori from "./images/thandoori chicken.jfif";
import lollipop from "./images/chicken lollipop.jfif";
import hotfriedchicken from "./images/hot chicken.jpeg";
import popcarnchicken from "./images/popcarn chicken.jpeg";
import chicken65 from "./images/chicken 65.jpeg";
import drypepperchicken from "./images/dry pepper chicken.jfif";
import southernfriedchicken from "./images/southern fried chicken.jpeg";
import crispyfriedchicken from "./images/crispy fried chicken.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Grill Chicken", image: grill, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Thandoori Chicken", image: thandoori, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.4"},
    { id: 3, name: "Chicken Lollipop", image: lollipop, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.3" },
    { id: 4, name: "Hot fried Chicken", image: hotfriedchicken,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.5" },
    { id: 5, name: "Popcarn Chicken", image: popcarnchicken, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.5"},
    { id: 6, name: "Chicken 65", image: chicken65, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.4" },
    { id: 7, name: "Dry Pepper Chicken", image: drypepperchicken, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.5" },
    { id: 8, name: "Spiecy Fried Chicken", image: southernfriedchicken, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.4" },
    { id: 9, name: "Crispy Fried Chicken", image: crispyfriedchicken, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Chicken</span> Varieties for You</h2>
