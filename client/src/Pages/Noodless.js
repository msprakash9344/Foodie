...
//banner
import banner from "./images/noodles banner.jpg"

import chickennoodless from "./images/chicken fried noodles.jpg";
import eggnoodles from "./images/egg fried noodles.jpg";
import prawnnoodles from "./images/prawn noodles.jpg";
import vegnoodles from "./images/veg noodles.jpg";
import beefnoodles from "./images/beef noodles.jpeg";
import ducknoodles from "./images/duck noodles.jpg";
import mushroomnoodles from "./images/mushroom noodles.jpg";
import manchuriannoodles from "./images/manchurian noodles.jpg";
import chineesnoodles from "./images/chinees noodles.jpg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Chicken Noodles", image: chickennoodless, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Egg Fried Noodles", image: eggnoodles, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.3"},
    { id: 3, name: "Prawn Fried Noodles", image: prawnnoodles, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.4" },
    { id: 4, name: "Veg Fried Noodles", image: vegnoodles,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.3" },
    { id: 5, name: "Beef Fried Noodles", image: beefnoodles, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.2"},
    { id: 6, name: "Duck Fried Noodles", image: ducknoodles, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.5" },
    { id: 7, name: "Mushroom Noodles", image: mushroomnoodles, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.4" },
    { id: 8, name: "Gobi Fried Noodles", image: manchuriannoodles, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.3" },
    { id: 9, name: "Chinees Noodles", image: chineesnoodles, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <div className="container py-5">
      <h2 className="text-center mb-4">Our Delicious <span style={{color:"orangered"}}>Fried Noodles</span> Varieties for You</h2>
