...
//banner 
import banner from "./images/cake banner.jpeg"
import chocolatecake from "./images/chocolate cake.jpg";
import blackforestcake from "./images/black forest cake.jfif";
import cherrycake from "./images/cherry cake.jpeg";
import redvelvetcake from "./images/red velvet cake.jpeg";
import honeycake from "./images/honey cake.jpeg";
import chocolatestrawberrycake from "./images/chocolate strawberry cake.jpeg";
import cheesecake from "./images/cheese cake.jpeg";
import carrotcake from "./images/carrot cake.jpeg";
import bluevalvetcake from "./images/blue valvet cake.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Chocolate Cake", image: chocolatecake, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Black Forest Cake", image: blackforestcake, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.4"},
    { id: 3, name: "Cherry Cake", image: cherrycake, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.5" },
    { id: 4, name: "Red Velvet Cake", image: redvelvetcake,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.5" },
    { id: 5, name: "Honey Cake", image: honeycake, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.4"},
    { id: 6, name: "Choco Strawberry Cake", image: chocolatestrawberrycake, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.5" },
    { id: 7, name: "Cheese Cake", image: cheesecake, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.5" },
    { id: 8, name: "Carrot Cake", image: carrotcake, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.3" },
    { id: 9, name: "Blue Valvet Cake", image: bluevalvetcake, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Cake</span> Varieties for You</h2>
