...
//banner
import banner from "./images/falooda bannner.jpg";

import blackkerentfalooda from "./images/blackkerent falooda.jpeg";
import strawberyfalooda from "./images/strawbery falooda.jpg";
import mangofalooda from "./images/mango falooda.jpeg";
import rosemilkfalooda from "./images/rose milk falooda.jpeg";
import pomegranatefalooda from "./images/pomegranate falooda.jpeg";
import kiwifalooda from "./images/kiwi falooda.jpeg";
import roserasmalaifalooda from "./images/rose rasmalai falooda.jpeg";
import orangestrawberyfalooda from "./images/orange strawbery falooda.jpeg";
import royalfalooda from "./images/royal falooda.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Blackkerent Falooda", image: blackkerentfalooda, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Strawbery Falooda", image: strawberyfalooda, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.4"},
    { id: 3, name: "Rose Milk Falooda", image: rosemilkfalooda, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.3" },
    { id: 4, name: "Pomegranate Falooda", image: pomegranatefalooda,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.5" },
    { id: 5, name: "Mango Falooda", image: mangofalooda, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.4"},
    { id: 6, name: "Kiwi Falooda", image: kiwifalooda, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.5" },
    { id: 7, name: "Rasmalai Falooda", image: roserasmalaifalooda, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.4" },
    { id: 8, name: "Orange Falooda", image: orangestrawberyfalooda, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.5" },
    { id: 9, name: "Royal Falooda", image: royalfalooda, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Falooda</span> Varieties for You</h2>
