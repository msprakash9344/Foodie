...
import chickenpizza from "./images/chicken pizza.jpeg";
import mushroompizza from "./images/mushroom pizza.jpeg";
import spicyvegpizza from "./images/spicy veg pizza.jpeg";
import turkishstylepizza from "./images/turkish style pizza.jpeg";
import panpizza from "./images/pan pizza.jpeg";
import detroitpizza from "./images/detroit pizza.jpeg";
import chillipizza from "./images/chilli pizza.jpeg";
import beefpizza from "./images/beef pizza.jpeg";
import cheespizza from "./images/chees pizza.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "chicken Pizza", image: chickenpizza, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Mushroom Pizza", image: mushroompizza, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.4"},
    { id: 3, name: "Spicy Veg Pizza", image: spicyvegpizza, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.5" },
    { id: 4, name: "Turkish Style Pizza", image: turkishstylepizza,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.3" },
    { id: 5, name: "Pan Pizza", image: panpizza, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.5"},
    { id: 6, name: "detroit pizza", image: detroitpizza, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.2" },
    { id: 7, name: "chilli Pizza", image: chillipizza, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.5" },
    { id: 8, name: "Beef Pizza", image: beefpizza, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.4" },
    { id: 9, name: "chees Pizza", image: cheespizza, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    ...
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Pizza</span> Varieties for You</h2>
