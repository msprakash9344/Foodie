...
//banner 
import banner from "./images/parotta banner.jpg"

import parotta from "./images/parotta.jpg";
import koththuparotta from "./images/koththu parotta.jpg";
import bunparotta from "./images/bun parotta.jfif";
import kizhiparotta from "./images/kizhi parotta.jfif";
import gobiparotta from "./images/gopi parotta.jpeg";
import pannerparotta from "./images/panner parotta.jpeg";
import keralaparotta from "./images/kerala parotta.jpeg";
import noolparotta from "./images/nool parotta.jpeg";
import alooparotta from "./images/aloo parotta.jpeg";
...
const App = () => {
  const foodData = [
    { id: 1, name: "Parotta", image: parotta, price: "80" ,offerprice:"60",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Koththu Parotta", image: koththuparotta, price: "150" ,offerprice:"120",offer:"off 20%",rating:"4.3"},
    { id: 3, name: "Bun Parotta", image: bunparotta, price: "100" ,offerprice:"90",offer:"off 10%",rating:"4.4" },
    { id: 4, name: "Kizhi Parotta", image: kizhiparotta,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.2" },
    { id: 5, name: "Gobi Parotta", image: gobiparotta, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.5"},
    { id: 6, name: "Panner Parotta", image: pannerparotta, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.4" },
    { id: 7, name: "Kerala Parotta", image: keralaparotta, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.5" },
    { id: 8, name: "Nool Parotta", image: noolparotta, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.3" },
    { id: 9, name: "Aloo Parotta", image: alooparotta, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return (
    <div>
      <div>
      <img src={banner} alt="banner"  className='banner' style={{height:"620px"}} />
      </div>
    <div className="container py-5">
    <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Parotta</span> Varieties for You</h2>
