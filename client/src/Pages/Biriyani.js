...
import banner from "./images/briyani banner.jpg"

import biriyani from "./images/chicken biriyani1.jfif";
import muttonbriyani from "./images/mutton briyani.jfif";
import prawnbriyani from "./images/prawn briyani.jfif";
import fishbriyani from "./images/fish briyani1.jfif";
import beefbriyani from "./images/beef briyani.jfif";
import duckbriyani from "./images/duck briyani.jfif";
import chillibriyani from "./images/65 briyani.jfif";
import mushroombriyani from "./images/mushroom briyani.jfif";
import eggbriyani from "./images/egg briyani.jfif";
...
const App = () => {
    ...
    const foodData = [
    { id: 1, name: "Chicken Briyani", image: biriyani, price: "200" ,offerprice:"150",offer:"off 25%",rating:"4.5"},
    { id: 2, name: "Mutton Briyani", image: muttonbriyani, price: "300" ,offerprice:"250",offer:"off 16%",rating:"4.3"},
    { id: 3, name: "Prawn Briyani", image: prawnbriyani, price: "250" ,offerprice:"180",offer:"off 28%",rating:"4.4" },
    { id: 4, name: "Fish Briyani", image: fishbriyani,price: "170" ,offerprice:"140",offer:"off 17%",rating:"4.2" },
    { id: 5, name: "Beef Briyani", image: beefbriyani, price: "120" ,offerprice:"90",offer:"off 32%",rating:"4.4"},
    { id: 6, name: "Duck Briyani", image: duckbriyani, price: "220" ,offerprice:"160",offer:"off 27%",rating:"4.5" },
    { id: 7, name: "65 Briyani", image: chillibriyani, price: "240" ,offerprice:"170",offer:"off 30%",rating:"4.3" },
    { id: 8, name: "Mushroom Briyani", image: mushroombriyani, price: "130" ,offerprice:"80",offer:"off 38%",rating:"4.4" },
    { id: 9, name: "Egg Briyani", image: eggbriyani, price: "110" ,offerprice:"70",offer:"off 36%",rating:"4.5" }
  ];
  ...
  return(
    ...
    <div className="container py-5">
      <h2 className="text-center mb-4">Our Delicius <span style={{color:"orangered"}}>Briyani</span> Varieties for You</h2>
  ...
  <div className="container">
    <div className="row">
      ...
      <div className='col-md-6 col-lg-3'>
        <img src={logo} style={{height:"300px" , marginTop:"-94px" , marginLeft:"-30px"}}></img>
    ...
    {/* Section 1: About */}
      ...
      {/* Section 2: Help */}
      <div className="col-md-6 col-lg-3">
        <h4 className='footerheading'>Help & Support</h4>
        <ul className="list-unstyled lh-lg footertext">
